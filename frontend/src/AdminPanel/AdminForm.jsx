...
export default function AdminForm({
  ...
  return (
    <div className="bg-gray-900 p-4 rounded border border-gray-700 space-y-4">
      <h3 className="text-lg text-center text-yellow-300 font-bold">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        {/* iGive */}
        <div className="flex flex-col">
          <label className="text-gray-300 mb-1">കിട്ടാനുളളത്</label>
          <input
            className="p-3 bg-gray-800 text-white border border-gray-600 rounded"
            placeholder="Type here..."
            type="number"
        ...
        {/* theyGive */}
        <div className="flex flex-col">
          <label className="text-gray-300 mb-1">തന്നത്</label>
          <input
            className="p-3 bg-gray-800 text-white border border-gray-600 rounded"
            placeholder="Type here..."
            type="number"
        ...
        {/* note */}
        <div className="flex flex-col">
          <label className="text-gray-300 mb-1">പയറ്റിയത്</label>
          <input
            className="p-3 bg-gray-800 text-white border border-gray-600 rounded"
            placeholder="Type here..."
            type="number"
      ...
      {form.id ? (
        <button
          className="w-full bg-purple-600 text-white p-2 rounded font-bold"
      ...
      <button
        className="w-full bg-red-800 text-white p-3 rounded font-bold"
        onClick={clearForm}
      >
        Cancel
      </button>
